...
GRANT ALL ON DATABASE STOCK_TRACKING_US_STOCK_PRICES_BY_DAY TO ROLE dbt_hol_role_{{env}};
GRANT ALL ON DATABASE FOREX_TRACKING_CURRENCY_EXCHANGE_RATES_BY_DAY TO ROLE dbt_hol_role_{{env}};

CREATE USER IF NOT EXISTS dbt_hol_user
  PASSWORD = 'Dbt_hol_2025!'
  DEFAULT_ROLE = dbt_hol_role_{{env}}
